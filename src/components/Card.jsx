        ...
        return (
          ...
          >
            <div className="flex justify-center w-96 h-80  ease-in-out rounded-lg cursor-pointer hover:shadow-md shadow-slate-50 scroll-smooth transition-transform duration-300 transform hover:scale-105 ">
              <div
                className="container relative   border-[4px] border-gray-200 rounded-lg flex flex-col items-center space-y-5 p-4 bg-cyan-500 hover:bg-cyan-600 shadow-lg hover:shadow-xl shadow-cyan-500 hover:shadow-cyan-700 bg-cover bg-center  "
                style={{
